...
exptArray = [2:4,5:7,9:12,13:15,17:19,21:22,26:27]; % use corresponding dataIndex values
...
for e = 1:length(exptArray)
    ...
    plotName = strcat('s12-',specificGrowthRate,'-',date,'-',num2str(specificBinning),'minbins-maxTime-bubble');
