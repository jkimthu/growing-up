%% figure S12 - growth rate vs time


%  Output: for each experiment, plot growth rate over time
...
%  last updated: jen, 2019 Mar 6

%  commit: summary plot of all data, without bubble trimmings
...
exptArray = [19,21:22,26:27]; % use corresponding dataIndex values
% [2:4,5:7,9:12,13:15,17:19,21:22,26:27];
...
for e = 1:length(exptArray)
    ...
    plotName = strcat('s12-',specificGrowthRate,'-',date,'-',num2str(specificBinning),'minbins-maxTime',num2str(maxTime));
