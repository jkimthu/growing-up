...
%  Last modified (jen): 2018 December 4
%  Commit: re-do particle tracking of 2018-09-18 with width threshold of 1.4um for conditions 1,2,3
%          
...
for ii = 1:NSeries
    ...
    Threshold = [-26.3448, -1]; %threshold for 2018-09-18 
    Background = [];                        
    PlotFlag = 0;                           
    ImType = {'Single'};                
