...
%  Last modified (jen): 2018 Sept 25
%  Commit: re-do particle tracking for 2017-11-13 with constant width
%          threshold
%          
...
for ii = 1:NSeries
    ...
    Threshold = [-44.1176, -1]; %threshold for 2017-11-13   
    Background = [];                        
    PlotFlag = 0;                           
    ImType = {'Single'};                
