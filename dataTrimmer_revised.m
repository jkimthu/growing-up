...
% commit: data trimming for sensitivity analysis of 2018-02-01, width 1p6
...
load(strcat('lb-fluc-',experiment,'-width1p6.mat'));
...
save(strcat('lb-fluc-',experiment,'-width1p6-jiggle-0p5.mat'), 'D', 'D2', 'D3', 'D4', 'D5', 'rejectD', 'T')%, 'reader', 'ConversionFactor')
