...
% commit: data trimming for sensitivity analysis of 2018-02-01, width 1p4
...
load(strcat('lb-fluc-',experiment,'-width1p4.mat'));
...
save(strcat('lb-fluc-',experiment,'-width1p4-jiggle-0p5.mat'), 'D', 'D2', 'D3', 'D4', 'D5', 'rejectD', 'T')%, 'reader', 'ConversionFactor')
