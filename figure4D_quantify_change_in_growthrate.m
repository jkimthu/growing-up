%% figure 4D - percent change in growth rate from pre-shift value
%
%
...
%         Part B. collect t=0 and t=7.5 growth rates from fluctuating data
%         Part C. collect t=0 and t=7.5 growth rates from single shift data
%         Part D. final quantifications of percent change from t=0 and t=7.5
%         Part E. plot quantifications



%  last updated: jen, 2019 Oct 8
%  commit: first commit, percent change from preshift growth rate at 7.5 min
%          postshift
...
%% Part B. collect t=0 and t=0 growth rates from fluctuating data
...
%% Part C. collect t=0 and t=0 growth rates from single shift data
...
%% Part D. quantify percent change from growth rate
...
%set(gca,'xticklabel',{'15min';'60min';'single'})
