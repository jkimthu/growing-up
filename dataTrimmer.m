...
save('2016-08-05_b-trimmed.mat', 'D', 'D2', 'D3', 'D4', 'D5', 'T')%, 'reader', 'ConversionFactor')
...
for n=31:40                                                                 % adjust n as needed!
    ...
    save('2016-08-05_b-Rejects.mat', 'Rejects')                              % saves current Rejects after finishing each series
...
for n=1:40                                                              % adjust n as needed!
    ...
    save('2016-08-05_b-Rejects.mat', 'Rejects','Trash')
...
%clear n;
save('2016-08-05_b-trimmed.mat', 'D', 'D2', 'D3', 'D4', 'D5', 'D6', 'T')%, 'reader', 'ConversionFactor')