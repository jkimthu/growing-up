...
load('lb-monod-2017-09-26-window5-jiggle-c12-0p1-c3456-0p5-bigger1p8.mat','D','D5','T','rejectD');
numMovies = length(D5);
...
save('lb-monod-2017-09-26-window5-va-jiggle-c12-0p1-c3456-0p5-bigger1p8.mat', 'D','D5', 'M_va', 'T','rejectD') %'D'
