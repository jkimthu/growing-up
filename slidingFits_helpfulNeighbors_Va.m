...
load('lb-control-2017-11-09-width1p4-jiggle-0p5.mat','D','D5','T','rejectD');
numMovies = length(D5);
...
save('lb-control-2017-11-09-window5-width1p4-jiggle-0p5.mat', 'D','D5','M', 'M_va', 'T','rejectD') %'D'
