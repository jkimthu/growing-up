...
load('lb-fluc-2017-11-01-width1p4v1p7-jiggle-0p5.mat','D','D5','T','rejectD');
numMovies = length(D5);
...
save('lb-fluc-2017-11-01-window5combo-width1p4v1p7-jiggle-0p5.mat', 'D','D5','M', 'M_va', 'T','rejectD') %'D'
