...
load('lb-fluc-2017-11-15-c123-width1p4-c4-1p7-jiggle-0p5.mat','D','D5','T','rejectD');
numMovies = length(D5);
...
save('lb-fluc-2017-11-15-window5-width1p4-1p7-jiggle-0p5.mat', 'D','D5','M', 'M_va', 'T','rejectD') %'D'
