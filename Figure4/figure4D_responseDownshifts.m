%% figure 4D - growth rate response to nutrient downshift
%
%  Output: two plots of growth rate response to downshifts in real time.
...
%  commit: final figure 4D for sharing from source data
