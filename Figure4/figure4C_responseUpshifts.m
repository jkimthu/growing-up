...
%         Part B. curves for single shift data
%         Part C. curves for fluctuating data
...
%% B1. curves for single shift data
...
%% B2. find mean and standard deviation between single-shift replicates
...
%% C1. compile and plot up or downshift data for each replicate 
...
%% C2. find mean and standard deviation between replicates
...
%% E. quantify % change in growth rate from pre-shift growth rate at t = 5 min 
