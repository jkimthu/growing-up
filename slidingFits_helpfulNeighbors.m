...
load('lb-fluc-2017-10-24-width1p4v1p7-jiggle-0p5.mat','D','D5','T','rejectD');
numMovies = length(D5);
...
%
save('lb-fluc-2017-10-24-window5-width1p4v1p7-jiggle-0p5.mat', 'D','D5', 'M', 'T','rejectD') %'D'
